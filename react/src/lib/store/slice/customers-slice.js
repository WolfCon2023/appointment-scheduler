...
export const getCustomers = createAsyncThunk(
  ...
  async () => {
    const res = await axios.get('https://vital-backoffice-apps-backend-development-mongodb.up.railway.app/api/customers')
    return res.data
  }
)
...
export const addCustomer = createAsyncThunk(
  ...
  async data => {
    ...
    console.log(data)
    const res = await axios.post('https://vital-backoffice-apps-backend-development-mongodb.up.railway.app/api/customers', data)
    return res.data
  }
)
